  ...
  const values = [
    {
      ...
      description:
        "We use sustainable methods and environmentally responsible products to protect your landscape and the planet.",
    },
    {
      icon: Shield,
      title: "Quality Guarantee",
      description:
        "Every project comes with our satisfaction guarantee. We stand behind our work with comprehensive warranties.",
    },
    {
      icon: Clock,
    ...
    },
    {
      ...
      description:
        "Your satisfaction is our priority. We listen to your needs and exceed your expectations every time.",
    },
  ]
  ...
  const timeline = [
    {
      ...
      description:
        "Elvis and Marco officially launched Cleanthelawn with a vision to provide exceptional landscaping services",
    },
    {
      year: "Summer 2025",
      event: "First Clients",
      description: "Successfully completed our first landscaping projects in Prince George's County",
    },
    {
      year: "Fall 2025",
      event: "Service Expansion",
      description: "Expanded services to include seasonal cleanup and maintenance programs",
    },
    {
      year: "2026",
      event: "Growth Phase",
      description: "Planning to serve multiple cities across Prince George's County",
    },
  ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about Cleanthelawn Landscaping's experienced team, company values, and commitment to excellence in Prince George's County landscaping services."
        />
        <meta
          name="keywords"
          content="landscaping company Prince George's County MD, professional landscaping team, College Park MD landscaping, eco-friendly lawn care"
        />
      ...
      <div className="pt-24 pb-20">
        ...
        <div className="pt-24">
            ...
            <div className="container mx-auto px-4 py-16">
              ...
              >
                ...
                <p className="text-xl text-green-700 max-w-3xl mx-auto leading-relaxed font-organic">
                  We're passionate about creating beautiful outdoor spaces in Prince George's County that enhance your
                  property value and quality of life. Our experienced team brings professionalism, reliability, and
                  eco-friendly practices to every project.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            {/* Company Overview */}
            <motion.div
              className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch mb-16"
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              <div className="space-y-6">
                ...
                <p className="text-green-700 leading-relaxed">
                  Cleanthelawn Landscaping has been serving Prince George's County communities with dedication and
                  expertise since June 2025. We specialize in comprehensive landscaping and property maintenance
                  services that enhance the beauty and value of residential and commercial properties.
                </p>
                <p className="text-green-700 leading-relaxed">
                  Founded by two ambitious young entrepreneurs, our commitment to excellence, combined with eco-friendly
                  practices and customer-focused service, makes us the emerging choice for property owners throughout
                  College Park, Bowie, Greenbelt, Hyattsville, and surrounding areas.
                </p>
              ...
              <div className="relative">
                <motion.div
                  className="bg-gray-700 rounded-2xl h-80 lg:h-96 flex items-center justify-center relative overflow-hidden"
                  whileHover={{ scale: 1.02 }}
                  transition={{ duration: 0.3 }}
                >
                  <img
                    src={aboutMainImage || "/placeholder.svg"}
              ...
              <div className="max-w-7xl mx-auto">
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8 items-stretch">
                    {/* Team Photo */}
                    <motion.div className="lg:col-span-2 relative h-full" whileHover={{ scale: 1.02 }}>
                      <img
                        src={ceo || "/placeholder.svg"}
                        alt="Elvis Carrillo (CEO) and Marcos Medina (Co-Founder) - Cleanthelawn Leadership Team"
                        className="w-full h-80 lg:h-full rounded-xl object-cover object-[center_40%] border-4 border-green-500 shadow-lg"
                        loading="lazy"
                        decoding="async"
                      />
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                          <div>
                            <div className="bg-green-50 rounded-lg p-4 h-full">
                              ...
                              <p className="text-gray-600 text-sm leading-relaxed">
                                Elvis Medina is an ambitious entrepreneur and junior in college from Prince George's
                                County, Maryland. A Dean's List student and resident advisor, he brings strong
                                leadership, discipline, and attention to detail in everything he does. With a deep
                                passion for entrepreneurship, service, and personal growth, Elvis balances academic
                                excellence with athletic drive. Guided by his faith in God and love for family, he is
                          ...
                          <div>
                            <div className="bg-emerald-50 rounded-lg p-4 h-full">
                              ...
                              <p className="text-gray-600 text-sm leading-relaxed">
                                Marco Carrillo is an investor and entrepreneur from Montgomery County, Maryland, with a
                                B.S. in Finance. He is driven, respectful, and known for his charismatic leadership and
                                strong sense of integrity. Grounded in his faith in God, Marco values family, health,
                                and serving the community. Outside of work, he enjoys playing basketball, hiking, and
                                expressing his creativity through hands-on activities. His passion for growth and giving
                                back inspires everything he does.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="pt-4 border-t border-gray-200">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {["Academic Excellence", "Community Service", "Faith & Family", "Entrepreneurial Growth"].map(
                            (focus, i) => (
                              <span
                                key={i}
            ...
            >
              ...
              <p className="text-xl text-green-700 mb-8 max-w-2xl mx-auto">
                Experience the difference that professional, reliable landscaping services can make for your property.
              </p>
              <Link
                to="/contact"
